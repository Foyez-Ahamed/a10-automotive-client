...
const AddProduct = () => {
  ...
  return (
    <div>
      ...
      <section className="flex justify-center items-center w-full md:w-full lg:w-3/4 shadow-xl rounded-xl p-3 mx-auto">
        <div>
          {/* main div */}
              ...
              <div className="flex flex-col md:flex-col lg:flex-row gap-6">
                <div className="form-control">
                  ...
                  <input
                    ...
                    name="image"
                    className="input mt-2 bg-[#F3F3F3] w-full md:w-[390px] lg:w-[390px]"
                  />{" "}
                </div>
