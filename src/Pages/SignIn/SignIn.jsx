...
<div>
<h1 className="text-center font-medium text-3xl text-[#403F3F] mb-6"> Sign in here please </h1>
</div>
...
<input type="submit" value= "Sign In" className=" btn w-full md:w-[390px] lg:w-[390px] mt-5 font-bold bg-[#E02C6D] text-white hover:bg-gray-600" />
</div>
</form>
...
<div className="mt-5">
    <p>Do not have an account ? <Link to='/signUp' className="text-bold text-[#1877F2] text-md uppercase underline">Sign up</Link></p>
</div>
